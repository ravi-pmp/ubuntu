Vagrant.configure("2") do |config|
  ...
  config.vm.define "master" do |master|
    ...
    master.vm.network "public_network", ip: "192.168.101.155"
  ...
  config.vm.define "node1" do |node1|
    ...
    node1.vm.network "public_network", ip: "192.168.101.156"
  ...
  config.vm.define "node2" do |node2|
    ...
    node2.vm.network "public_network", ip: "192.168.101.157"
  ...
  config.vm.define "node3" do |node3|
    ...
    node3.vm.network "public_network", ip: "192.168.101.158"
